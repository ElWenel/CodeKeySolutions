import { Rocket, Palette, Zap, Handshake, Code2 } from "lucide-react";
...
export const translations = {
  en: {
    ...
    services: {
      title: "Our Services",
      subtitle: "Everything you need to launch your online presence.",
      items: [
        {
          icon: Rocket,
          title: "Fast Development",
          description: "We build and deliver your landing page in record time.",
        },
        {
          icon: Palette,
          title: "Custom Design",
          description: "Unique and modern designs tailored to your brand.",
        },
        {
          icon: Zap,
